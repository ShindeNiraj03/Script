...
:: TIP: copy the exact name from "net user" output on the target
:: to avoid typos or hidden trailing spaces. Using quotes below
:: prevents accidental trailing-space bugs.
